...
#This is the second step: bbmerge, to merge paired-end sequences.
#Users need to download BBTools from the Joint Genome Institute: https://jgi.doe.gov/data-and-tools/bbtools/


InDir="../01trim"  #Trimed sequences data
OutDir="../02merge" #Folder to keep merged paired-end reads sequences
...
../bbmerge.sh in1=$InDir/$s.1.fq in2=$InDir/$s.2.fq out=$OutDir/$s.m.fastq outu1=$OutDir/$s.um1.fastq outu2=$OutDir/$s.um2.fastq flatmode=t margin=1 pfilter=0 
